...
const Register = ({ setRewards }) => {
  ...
  const { RandonPokeball, RandonPokemon, RandonHowPokemons } = useFetchPokemons();
    ...
    <div className="auth kanit">
      ...
      <div className="inputs">
        <form onSubmit={handleSubmit}>
          ...
          {!loading && <button className="btn-default">Cadastrar</button>}
          {loading && (
